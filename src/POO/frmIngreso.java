...
public class frmIngreso extends javax.swing.JFrame {
    ...
    //Declarar listaUsuarios usuario
    private ListaUsuario listaUsuario;
    
    public frmIngreso() {
        initComponents();
        listaUsuario = new ListaUsuario();
        listaUsuario.agregar("Hector", "12345");
        listaUsuario.agregar("Carlos", "12345");
        listaUsuario.agregar("Alan", "12345");
        listaUsuario.agregar("Karla", "12345");
        listaUsuario.agregar("Moises", "12345");
    ...
    private void initComponents() {
        ...
        jlbResultado.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
    ...
    private void jbnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbnAceptarActionPerformed
        ...
        if(listaUsuario.buscarDato(usr, con))
         {

                //Se pasa como parametros: Usuario y ventana actual
                frmCotizador abrir = new frmCotizador();
    ...
    /*
      public Usuario buscarDato(String u, String c)
    {
        Usuario aux = ListaUsuario.usuarios;
        ...
        if(aux != null)
        {
            ...
            {
                if(u == aux.getUsuario() && c == aux.getContraseña())//comparacion
                {
                    jlbMensaje.setText("Valor encontrado en posicion"+pos);
                    encontrado = true;
                    return aux;  
            ...
            if(!encontrado)
            {
                jlbMensaje.setText("Valor no encontrado");
                return null;
            }
            else
            {
                jlbResultado.setText("Lista vacia");
                return null;
            }
